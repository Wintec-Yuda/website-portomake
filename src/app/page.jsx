...
import { 
  ...
  FiUserCheck, FiBriefcase, FiTrendingUp,
  FiRefreshCw, FiStar, 
} from 'react-icons/fi';
  ...
  return (
    ...
    >
      ...
      <div className="px-8 py-4 bg-gray-50 border-t border-gray-200">
        <motion.a
          href={`https://wa.me/6281230490961?text=${encodeURIComponent(`Saya tertarik dengan paket ${name}`)}`}
          target="_blank"
...
function ContactForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const encodedMessage = encodeURIComponent(`Halo, nama saya ${name}. ${message}`);
